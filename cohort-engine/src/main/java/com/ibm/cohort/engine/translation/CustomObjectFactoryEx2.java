...
//// todo: [daniel.kim] add unit test to guard that new ObjectFactoryEx methods
public class CustomObjectFactoryEx2 extends ObjectFactoryEx {
	@Override
	...
	public Current createCurrent() {
		return super.createCurrent();
	}

	@Override
	public Iteration createIteration() {
		return super.createIteration();
	}

	@Override
	public Total createTotal() {
		return super.createTotal();
	}
	...
	public LetClause createLetClause() {
		return super.createLetClause();
	}

	@Override
	public With createWith() {
		return super.createWith();
	}

	@Override
	public Without createWithout() {
		return super.createWithout();
	}

	@Override
	public ByDirection createByDirection() {
		return super.createByDirection();
	}

	@Override
	public ByColumn createByColumn() {
		return super.createByColumn();
	}

	@Override
	public ByExpression createByExpression() {
		return super.createByExpression();
	}

	@Override
	public SortClause createSortClause() {
		return super.createSortClause();
	}

	@Override
	public ReturnClause createReturnClause() {
		return super.createReturnClause();
	}

	@Override
	public ValueSetDef createValueSetDef() {
		return super.createValueSetDef();
	}
